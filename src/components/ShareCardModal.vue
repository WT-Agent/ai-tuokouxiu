    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">AI脱口秀与吐槽</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 脱口秀与吐槽金句助手</span>
...
// 清理回复末尾的特殊标记 [TUOKOUXIU_SCORES]...[/TUOKOUXIU_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[TUOKOUXIU_SCORES\][\s\S]*?\[\/TUOKOUXIU_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - AI脱口秀与吐槽金句】\n\n${cleanContent.value}\n\n体验爆笑脱口秀AI助手：https://ai.wuxian.xyz`;
